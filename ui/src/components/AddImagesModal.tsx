          ...
          >
            <div className="bg-white dark:bg-zinc-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="text-center">
                <DialogTitle as="h3" className="text-base font-semibold text-zinc-900 dark:text-zinc-200 mb-4">
                ...
                <div className="w-full">
                  <div
                    ...
                    className={`h-40 w-full flex flex-col items-center justify-center border-2 border-dashed rounded-lg cursor-pointer transition-colors duration-200
                      ${isDragActive ? 'border-blue-500 bg-blue-50/10' : 'border-zinc-300 dark:border-zinc-600'}`}
                  >
                    <input {...getInputProps()} />
                    <FaUpload className="size-8 mb-3 text-zinc-500 dark:text-zinc-400" />
                    <p className="text-sm text-zinc-800 dark:text-zinc-200 text-center">
            ...
            <div className="bg-zinc-100 dark:bg-zinc-700 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                ...
                className={`inline-flex w-full justify-center rounded-md bg-zinc-800 text-white dark:bg-zinc-600 px-3 py-2 text-sm font-semibold shadow-xs sm:ml-3 sm:w-auto
              ...
              <button
                ...
                onClick={onCancel}
                disabled={isUploading}
                className={`mt-3 inline-flex w-full justify-center rounded-md bg-zinc-200 dark:bg-zinc-800 px-3 py-2 text-sm font-semibold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300 dark:hover:bg-zinc-800 sm:mt-0 sm:w-auto ring-0
                  ${isUploading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                Cancel
              </button>
