      ...
      <MainContent>
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-10">
          ...
          <section className="space-y-6">
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <Description>
                  We will store your training information here. Must be an absolute path. If blank, it will default to
                  the output folder in the project root.
                </Description>
                <Input
                  type="text"
          ...
          <section className="space-y-6">
            ...
            <FieldGroup>
              <Field>
                ...
                <Description>
                  Enable the Claude AI assistant for config help, log analysis, and dataset captioning. Get a key from{' '}
                  <a
              ...
              <Field>
                ...
                <Description>
                  Model used for generating image captions. Haiku is recommended for speed and cost when captioning many
                  images.
                </Description>
          ...
          <div className="flex items-center gap-4">
            <Button type="submit" color="blue" disabled={status === 'saving'}>
